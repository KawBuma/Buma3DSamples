                                    ...
                                    , TEXTURE_CREATE_FLAGS _texture_flags = TEXTURE_CREATE_FLAG_NONE, RESOURCE_FLAGS _flags = RESOURCE_FLAG_NONE)
{
    ...
    result.texture = TEXTURE_DESC{
        EXTENT3D{ _size.width, _size.height, 1 },
        _array_size,
        _mips,
        _sample_cont,
...
{
    return RENDER_TARGET_VIEW_DESC{
          VIEW_DESC{ VIEW_TYPE_RENDER_TARGET, _format, _array_size >= 1 ? VIEW_DIMENSION_TEXTURE_2D_ARRAY : VIEW_DIMENSION_TEXTURE_2D }
