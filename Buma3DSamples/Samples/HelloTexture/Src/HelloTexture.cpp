...
bool HelloTexture::CreateShaderModules()
{
    ...
    desc.options.shift_all_tex_bindings     = 1; // register(t0, space0) -> register(t1, space0)
    desc.options.shift_all_samp_bindings    = 2; // register(s0, space0) -> register(s2, space0)
