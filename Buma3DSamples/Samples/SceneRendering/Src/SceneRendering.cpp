...
class SceneRendering::ResizeEvent : public IEvent
{
public:
    ResizeEvent(SceneRendering& _owner) : owner{ _owner } {}
    virtual ~ResizeEvent() {}
    void Execute(IEventArgs* _args) override { owner.OnResize(static_cast<ResizeEventArgs*>(_args)); }    
private:
    SceneRendering& owner;
};

class SceneRendering::BufferResizedEvent : public IEvent
{
public:
    BufferResizedEvent(SceneRendering& _owner) : owner{ _owner } {}
...
class SceneRendering::ProcessMessageEvent : public IEvent
{
public:
    ProcessMessageEvent(SceneRendering& _owner) : owner{ _owner } {}
...
SceneRendering* SceneRendering::Create()
{
    return new SceneRendering();
}

bool SceneRendering::Prepare(PlatformBase& _platform)
{
    platform = &_platform;
    ...
    settings.window_desc.name           = "Buma3DSamples - SceneRendering | Press F3 to show ImGui windows";
...
void SceneRendering::PrepareSubmitInfo()
{
    // キューへの送信情報
...
void SceneRendering::CreateEvents()
{
    // イベントを登録
...
bool SceneRendering::InitSwapChain()
{
...
bool SceneRendering::LoadAssets()
{
...
bool SceneRendering::LoadTextureData()
{
...
bool SceneRendering::CreateDescriptorSetLayout()
{
...
bool SceneRendering::CreatePipelineLayout()
{
...
bool SceneRendering::CreateDescriptorHeapAndPool()
{
...
bool SceneRendering::AllocateDescriptorSets()
{
...
bool SceneRendering::CreateRenderPass()
{
...
bool SceneRendering::CreateFramebuffer()
{
...
bool SceneRendering::CreateShaderModules()
{
    b::BMRESULT bmr{};
...
bool SceneRendering::CreateGraphicsPipelines()
{
    b::BMRESULT bmr{};
    // グラフィックスパイプラインの作成
    {
...
bool SceneRendering::CreateCommandAllocator()
{
...
bool SceneRendering::CreateCommandLists()
{
...
bool SceneRendering::CreateFences()
{
    b::BMRESULT bmr;
    b::FENCE_DESC fd{};
...
bool SceneRendering::CreateBuffers()
{
...
bool SceneRendering::CopyBuffers()
{
    copy_ctx.Begin();
...
bool SceneRendering::CreateBufferViews()
{
    b::BMRESULT bmr{};
    // 頂点バッファビューを作成
    {
...
bool SceneRendering::CreateConstantBuffer()
{
    // 定数バッファを作成します。
...
bool SceneRendering::CreateConstantBufferView()
{
...
bool SceneRendering::CreateTextureResource()
{
...
bool SceneRendering::CopyDataToTexture()
{
    auto&& data_desc = texture.data->GetDesc();
...
bool SceneRendering::CreateShaderResourceView()
{
...
bool SceneRendering::CreateSampler()
{
    b::SAMPLER_DESC sd{};
...
bool SceneRendering::UpdateDescriptorSets()
{
...
bool SceneRendering::InitMyImGui()
{
...
bool SceneRendering::CreateMyImGuiFramebuffers()
{
    for (uint32_t i = 0; i < BACK_BUFFER_COUNT; i++)
    {
...
void SceneRendering::PrepareFrame(uint32_t _buffer_index)
{
...
void SceneRendering::OnResize(ResizeEventArgs* _args)
{
...
void SceneRendering::OnResized(BufferResizedEventArgs* _args)
{
    back_buffers     = &swapchain->GetBuffers();
    swapchain_fences = &swapchain->GetPresentCompleteFences();
...
void SceneRendering::OnProcessMessage(ProcessMessageEventArgs* _args)
{
    if (!is_enabled_gui)
        return;
